...
public class MealActivity extends AppCompatActivity
  ...
  private void setupDrawerContent() {
    ...
    TextView headerNameView = headerView.findViewById(R.id.header_schoolname);
    TextView headerPathView = headerView.findViewById(R.id.header_path);
